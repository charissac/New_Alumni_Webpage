		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" style="background-image: url(images/background.jpg);">
				<div class="desc animate-box">
					...
					<tr>
					<td><span><a href="indexLinkedInNew.php">
					<img src="images/LargeLinkedIn.png" alt="LinkedIn"> </a></td></span>
					</tr>
					
					<tr>
					<td><span><a class="btn btn-primary" href="alumni.php"><font face="verdana">Create Account</span></td>
					</tr>
