...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <p>
						   <label><font color="purple"><b>*User Name: </b></font> </label>             
                            <input type="text" name="username"  size="70" required/>
                            </p>
                            <p>
                            ...
                            <input type="text" name="fullname" size="70"  required/>
                           </p>
						   ...
						   <p>
							...
							<img id="picture" src="uploads/noprofilepicture.png" alt="your image" height="200" width="200"/>
							  </p>
							  <p>
