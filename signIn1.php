  ...
  <!-- 
	...
	<body>
		...
		<div id="fh5co-header">
			<div class="top">
				<div class="container">
					<span> <a href="#"><i>@</i>UM_Alumni@alumnimail.com</a></span>
					<span> <a href="tel://+12345678910"><i class="icon-mobile3"></i> 011 26967179</a></span>
				</div>
			</div>
			<!-- end:top -->
			<header id="fh5co-header-section">
				<div class="container">
					<div class="nav-header">
						...
						<h1 id="fh5co-logo"><a href="index.html">UM Alumni</a></h1>
						<!-- START #fh5co-menu-wrap -->
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							<li><a href="signUp.php">Sign In</a></li>
							<li><a href="register1.php">Sign Up Here</a></li>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" style="background-image: url(images/background.jpg);">
				<div class="desc animate-box">
					<h2>UM Alumni Sign In</h2>
					<span>Lovely Created by Ruby Pua</span>
					<form method="post">
					<table align="center" width="0%" border="0">
					<tr>
					<td><font face="verdana"><input type="text" style="color: #C0C0C0;" name="email" placeholder="Your Email" required /></td>
					</tr>
					<tr>
					<td><font face="verdana"><input type="password" style="color: #C0C0C0;" name="pass" placeholder="Your Password" required /></td>
					</tr>
					<tr>
					<td><font face="verdana"><button type="submit" class="btn btn-primary"  name="btn-login"><font face="verdana">Sign In</button></td>
					</tr>
					<tr>
					<td><font face="verdana">Do not have an account? </font><span><a href="register1.php">Sign Up Here</a></font></td><span>
					</tr>
					<tr>
					<td><span><a href="loginadmin.php">Login as admin</a><span></td>
					</tr>
					</table>
				</form>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 animate-box">
						...
						<p>Far far away, behind the UM mountains</p>
					</div>
					<div class="col-md-9">
						<div class="row">
							<div class="col-md-4 col-sm-4">
								<div class="fh5co-grid animate-box" style="background-image: url(images/work-2.jpg);">
									<a class="image-popup text-center" href="index.php">
										<div class="prod-title">
											<h3>Don’t Just Stand There, Click me to sign in</h3>
											<span></span>
										</div>
									</a>
								</div>
