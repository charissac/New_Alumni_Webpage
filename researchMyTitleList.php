...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">My Research Title List</h2>
  <div align="center">
...
$result = mysqli_query($conn,"SELECT researchID, title,author,date FROM researchcollaboration WHERE admin_ind ='N' AND createUserID=  " .$_SESSION['user']);
$number = 1;
...
if (mysqli_num_rows($result ) > 0)	{		
	while ($row = mysqli_fetch_array($result, MYSQL_NUM)) {
		...
		echo " 	<tr><td>".$number.".</td> 
				<td> <a href='researchMyView.php?rid=".$row['0']."'> ".$row['1']." </a> </td>
				<td>".$row['2']."</td>
				<td>  ".$row['3']."  </td> 
				</tr>";
