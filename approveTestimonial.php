...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Approve Testimonial</h2>
  <div align="center">
  
   <form action="process_approveTestimonial.php" method="post" enctype="multipart/form-data">
...
$result = mysqli_query($conn,"SELECT testimonial_ID, title,author,date FROM testimonial WHERE status = '1' ");
$number = 1;
...
echo "  <tr>
		<td><input type='checkbox' name='testimonial_ID[".$number."]' value='". $row['0'] ."' /></td>
...
echo "<br/>";
	...
	//echo "</table>";
	echo "<h3>No New Testimonials. </h3>";
	echo "</table>";
	echo "<br/>";
echo "<br/>";
}
