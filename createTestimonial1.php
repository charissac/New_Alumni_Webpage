...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <p>  <label><font color="purple"><b>Title: </b></font></label>
	   <input type="text" size="70" name="title" required/>
		...
		<p> <label><font color="purple"><b>Content:  </b></font> </label><textarea rows="10" cols="70" name="content" />  </textarea> </p>
...
//if ($_POST["content"] != ""){
	...
	{ 
		...
		$q = "insert into testimonial(createUserID,author, title, content, date, status) values('".$_SESSION['user']."','".$userRow['fullName']."','".$_POST["title"]."','".$_POST["content"]."',NOW(), '1')";
