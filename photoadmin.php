 ...
 <nav id="fh5co-menu-wrap" role="navigation">
            <ul class="sf-menu" id="fh5co-primary-menu">
              <li><a href="admin.php">Home</a></li>
                  ...
                  <li>
                    <a href="#" class="fh5co-sub-ddown">News and Event</a>
                   ...
                   <li>
                    <a href="#" class="fh5co-sub-ddown">Testimonial</a> 
                  </li>
                <li><a href="admin.php">Job Area</a>
                <ul class="fh5co-sub-menu">
                  <li><a href="admin.php">View All Jobs</a></li>
                  <li><a href="admin.php">View My Job List</a></li>
                  <li><a href="admin.php">Post Job Advertisement</a></li>
                </ul>
              </li>
                <li><a href="admin.php">Alumni Account</a>
                <ul class="fh5co-sub-menu">
                  <li><a href="admin.php">Directory</a></li>
                  <li><a href="admin.php">Generate Account</a></li>
                </ul>
              </li>
                <li><a href="admin.php">Survey and Report</a>
                <ul class="fh5co-sub-menu">
...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <div align="center">
   <form action="processphoto.php" method="post" enctype="multipart/form-data" onSubmit="alert('Successful posted!');">
 ...
 <input type="file" name="photo" required>
               ...
               <p>
                <input type="submit" value="Upload photo"/> </p>
   ...
   <br><a href="photoslideshow.php"><font face="verdana">Proceed to Gallery </font></a></br><p></p>
      <a href="photoslideshowpreview.php"><font face="verdana">Proceed to Slideshow </font></a>
</div>
</div>
        </div>
      </div>
