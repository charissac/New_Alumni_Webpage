...
<div style = "background: rgba(255, 255, 255, 0.9);">
 ...
 <form action="process_approveFriendRequestProfile.php" method="post" enctype="multipart/form-data">					
 ...
 <p>  <label><font color="purple"><b>Name: </b></font></label>
	   <input type="text" size="70" name="fullname" value="<?php echo $userRow['fullName']; ?> " disabled ;/>
		...
		//echo " <input class='btn btn-primary' type='submit' value='Approve' onclick= 'return confirm('Are you sure want to confirm this?')' disabled/> <font face='verdana'> ";
		//}
		//else {
		...
		$friendRequest = mysqli_query($conn,"SELECT * FROM friend WHERE fromUserID = '". $userRow['userID']."' AND toUserID = ".$_SESSION['user']);

		$friendRow=mysqli_fetch_array($friendRequest);
		
		if ($friendRow['status'] == '1')
		{
			echo " <input class='btn btn-primary' name='action'  type='submit' value='Approve' onclick= 'return confirm('Are you sure want to approve this?')' /> <font face='verdana'> ";
		...
		{
			echo " <input class='btn btn-primary' name='action' type='submit' value='Approve' onclick= 'return confirm('Are you sure want to approve this?')' style='display: none' /> <font face='verdana'> ";
			echo " <input class='btn btn-primary' name='action' type='submit' value='Reject' onclick= 'return confirm('Are you sure want to reject this?')' style='display: none' /> <font face='verdana'> ";
		}
			 ...
			 <br/>
              ...
              <br> <p style="text-align: center;"><a class="btn btn-primary" href="approveFriend.php"><font face="verdana"><b>Back </b></a> </p>
