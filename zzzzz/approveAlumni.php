 ...
 <nav id="fh5co-menu-wrap" role="navigation">
            <ul class="sf-menu" id="fh5co-primary-menu">
              <li><a href="admin.php">Home</a></li>
                ...
                <ul class="fh5co-sub-menu">
					<li><a href="approveAlumni.php">Approve Alumni</a></li>
...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Please insert the photo you want to display</h2>
  <div align="center">
...
echo "  <tr><td>".$number.".</td> 
			<td> <a href='viewPendingProfile.php?uid=".$row['0']."'> ".$row['1']." </a> </td><td>".$row['2']."</td><td>".$row['3']."</td> <td>".$row['4']."</td> <td>".$row['5']."</td> 
			</tr>";
//}
//else{
//echo "  <tr><td>".$number.".</td> 
//<td><input type='checkbox' name='userID[".$number."]' value=0' /></td>
//			<td><input type='checkbox' name='userID[".$number."]' value='". $row['0'] ."' /></td>
//			<td> <a href='viewPendingProfile.php?uid=".$row['0']."'> ".$row['1']." </a> </td><td>".$row['2']."</td><td>Admin</td> <td>".$row['4']."</td></tr>";
//}
$number = $number + 1;
...
?>
 ...
 echo "<p><a href='approvingAlumni.php'><font face='verdana'><b>Approve Alumni</b></a> </p>";
 echo "<p><a href='rejectAlumni.php'><font face='verdana'><b>Reject Alumni</b></a> </p>";
