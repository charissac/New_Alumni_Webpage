...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Approve Alumni</h2>
  <div align="center">
  
   <form action="process_approveAlumni.php" method="post" enctype="multipart/form-data">
...
$result = mysqli_query($conn,"SELECT userID,fullName,programme,major,graduateYear,evidence FROM user WHERE status=1");
$number = 1;
...
echo "  <tr>
		...
		<td>  <a href= 'evidence/".$row['5']."'  download> Evidence </a> </td> 
...
echo "<br/>";
	...
	//echo "</table>";
	echo "<h3>No New Alumni Registration.</h3>";
	echo "</table>";
	echo "<br/>";
echo "<br/>";
}
