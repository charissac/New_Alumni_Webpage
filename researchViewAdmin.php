...
<div style = "background: rgba(255, 255, 255, 0.9);">
  ...
  <form action="process_researchViewAdmin.php" method="post" enctype="multipart/form-data">
		...
		<p> <label><font color="purple"><b>*Title: </b></font></label>
			<input type="text" size="70" name="title" value = "<?php echo $researchRow['title'];?>" disabled ;/>
	   </p>
		
		<p> <label><font color="purple"><b>Description:  </b></font> </label>
			<textarea rows="10" cols="70" name="description" value = "<?php echo $researchRow['description'];?>" disabled ; />  </textarea> 
		</p>
		...
		<p>	<label><font color="purple"><b>*Contact Email: </b></font> </label> 
            <input type="email" name="contactEmail" size="70"  value = "<?php echo $researchRow['contactEmail'];?>" disabled ;/>
		</p>
		
		<p>	<label><font color="purple"><b>Contact number: </b></font> </label> 
            <input type="text" name="contactNumber" size="70" value = "<?php echo $researchRow['contactNum'];?>" disabled ;/>
		</p>
		
		<p>	<label><font color="purple"><b>*Cooperation: </b></font> </label> 
            <input type="text" name="cooperation" size="70"  value = "<?php echo $researchRow['cooperation'];?>" disabled ;/>
		</p>
		...
		<INPUT TYPE="text" NAME="researchID"  value="<?php echo $researchRow['researchID']; ?>" style="display: none">
		 ...
		 <p style="text-align: center;"> <input class="btn btn-primary" name="action"  type="submit" value="Delete"  onclick= "return confirm('Are you sure want to delete this?')" /> <font face="verdana"></br>
