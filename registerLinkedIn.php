...
<script type="text/javascript" src="indexLinkecInNew.php"></script> 
			<script type="text/javascript" src="registerLinkedIn.php"></script> 
 ...
 <p>
						   <label><font color="purple"><b>*User Name: </b></font> </label>             
                            ...
                            <input type="text" name="matricnumber" size="70" value = "-" required/>
                           </p>
                            ...
                            <input type="text" name="phonenumber" size="70" value = "-" required/>
						   ...
						   <p>
                            ...
                            <input type="text" name="occupation" size="70" required/>
                           </p>
							...
							<img id="picture" src="<?php if($_GET['pictureURL'] == ""){echo "uploads/noprofilepicture.png";}
