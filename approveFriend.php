...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Friend Request</h2>
  <div align="center">
  
   <form action="process_approveFriendRequest.php" method="post" enctype="multipart/form-data">
...
$friendRequest = mysqli_query($conn,"SELECT * FROM friend WHERE status = '1' AND toUserID = ".$_SESSION['user']);
...
//$result = mysql_query("SELECT userID,fullName,programme,major,graduateYear FROM user WHERE userID=" .$friendRow['fromUserID']);
$number = 1;
...
//while ($friendRow=mysqli_fetch_array($friendRequest)) {
	...
	echo "  <tr>
		...
		<td> <a href='approveFriendPendingProfile.php?uid=".$row['0']."'> ".$row['1']." </a> </td>
		<td>".$row['2']."</td>
		<td>  ".$row['3']."  </td> 
		<td>  ".$row['4']."  </td> 
