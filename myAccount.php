...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">My Account - Change Password</h2>
  <div align="center">
  
   <form action="process_changepassword.php" method="post" enctype="multipart/form-data" onSubmit="alert('Your password have been changed.');">


                      
 <p>  <label><font color="purple"><b>User Name: </b></font></label>
  <input type="text" size="70" name="fullname" value="<?php echo $userRow['userName']; ?> " disabled ;/>
