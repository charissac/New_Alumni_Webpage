...
<div style = "background: rgba(255, 255, 255, 0.9);">
  <h2 style = "color: #7c795d; font-family: 'Trocchi', serif; font-size: 30px; font-weight: normal; line-height: 48px; margin: 0;text-align: center;">Reject Alumni</h2>
  <div align="center">
  
   <form action="process_rejectAlumni.php" method="post" enctype="multipart/form-data" onSubmit="alert('Applications have been rejected.');">
...
?>
 ...
 <input type="submit" value="Reject" onclick="return confirm('Are you sure want to reject this?')" /> </p>
 <p><a href="approveAlumni.php"><font face="verdana">Back to alumni list</a> </p>
